...
export default async function handler(request: VercelRequest, response: VercelResponse) {
  ...
  try {
    ...
    // Configuración de metadatos del nodo (ADN de Miguel Lara Abogados)
    const nodeId = 'node_miguel_lara_abogados';
    const businessName = 'Miguel Lara Abogados';
    const niche = 'Servicios Jurídicos / Abogados';
